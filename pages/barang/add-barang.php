...
<head>
    ...
    <title>TAMBAH BARANG | KASIR - TOKO BERKAH</title>
    <!-- Favicon-->
                        ...
                        <div class="body">
                            <form action="" method="POST">
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="Kode Barcode" name="kode_barcode" class="form-control" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="Nama Barang" name="nama_barang" class="form-control" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" id="Harga Beli" name="harga_beli" class="form-control" required>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="number" id="Harga Jual" name="harga_jual" class="form-control" required>
...
if(isset($_POST['submit'])){
    ...
    $sql = mysqli_query($conn,"INSERT INTO tb_barang VALUES('$kode_barcode','$nama_barang','$satuan','$harga_beli','$stok','$harga_jual','$profit')");
    if($sql){
        echo "
        <script>
            alert('success')
